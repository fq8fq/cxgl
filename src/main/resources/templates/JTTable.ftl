    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">邮政车险客户管理系统V1.0</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                         <li>
                            <a href="#"><i class="fa fa-edit fa-fw"></i>用户数据查询<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="notifications.html">未维护数据明细查询</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw"></i>用户数据维护</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i>批量文件导入<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">导入保险公司初始数据</a>
                                </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i>明细数据提取<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">未维护用户明细数据导出</a>
                                </li>
                                <li>
                                    <a href="#">已维护用户明细数据导出</a>
                                </li>
                                <li>
                                    <a href="#">到期用户明细数据导出</a>
                                </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="margin-right:auto">
